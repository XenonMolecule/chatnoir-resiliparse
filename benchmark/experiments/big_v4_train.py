...
OUT = "benchmark/experiments/big_v4_cache"
...
print(f"GBR v4 n120d6: AUC {roc_auc_score(yb, pred):.4f}", flush=True)
import joblib
joblib.dump(m, "benchmark/experiments/gbm_v4big_n120d6.joblib")
