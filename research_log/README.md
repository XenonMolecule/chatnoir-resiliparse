...
lpv11/dev (raw HTML, markdown config since 0009): F1 **0.8288** / Lev **0.7328** (0086) · golden **0.8482/0.7603** (v7) · train 0.8145/0.7159 — M1 crossed; test@M1 0.8218/0.7225. Goal: 0.90 / 0.80–0.85 (GOALS.md). Baseline 0.7619/0.6540 (0001).
