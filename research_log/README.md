...
lpv11/dev (raw HTML, markdown config since 0009): F1 **0.8174** / Lev **0.7211** (0051) · train 0.8083/0.7078 — **M1 crossed; test 0.8218/0.7225**. Goal: 0.90 / 0.80–0.85 (GOALS.md). Baseline 0.7619/0.6540 (0001).
