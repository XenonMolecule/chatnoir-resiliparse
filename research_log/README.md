...
lpv11/dev (raw HTML, markdown config since 0009): F1 **0.8518** / Lev **0.7594** (0110) · golden **0.8820/0.8009** (v12) — M1 crossed; test@M1 0.8218/0.7225. Goal: 0.90 / 0.80–0.85 (GOALS.md). Baseline 0.7619/0.6540 (0001).
