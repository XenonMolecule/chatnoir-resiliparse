...
lpv11/dev (raw HTML, markdown config since 0009): F1 **0.8455** / Lev **0.7520** (0104) · golden **0.8710/0.7889** (v11) — M1 crossed; test@M1 0.8218/0.7225. Goal: 0.90 / 0.80–0.85 (GOALS.md). Baseline 0.7619/0.6540 (0001).
