...
const SITE_VETOES: &[(&[u8], &[u8])] = &[
    ...
    (b"bikeforums.net", b"#collapseobj_similarthreads1048048"),
    (b"bikeforums.net", b".lastpost"),
    (b"bikeforums.net", b".tcat"),
    (b"bikeforums.net", b".threadstarter"),
    (b"bikeforums.net", b".tinyfont"),
    (b"bikeforums.net", b".top-nav-left"),
    ...
    (b"docme.ru", b".abuse"),
    (b"docme.ru", b".author_link"),
    (b"docme.ru", b".right_column_label"),
    ...
    (b"happysadlola.blogspot.com", b"#BlogArchive1"),
    (b"happysadlola.blogspot.com", b"#Label1"),
    (b"happysadlola.blogspot.com", b"#PopularPosts1"),
    ...
    (b"retrobike.co.uk", b".breadcrumbs"),
    (b"retrobike.co.uk", b".postdetails"),
    (b"retrobike.co.uk", b".profile"),
