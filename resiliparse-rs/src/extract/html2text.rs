...
const SITE_WHITELIST: &[(&[u8], &[u8])] = &[
    ...
    (b"dictionary.reference.com", b"#difficulty-box"),
    ...
    (b"census.gov", b".topics1"),
    (b"census.gov", b".topics10"),
    (b"census.gov", b".topics5"),
    (b"census.gov", b".topics6"),
    (b"census.gov", b".topics9"),
    ...
    (b"dictionary.reference.com", b".right-rail-nearby-words"),
    ...
    (b"ethicalhacker.net", b".signature"),
...
const SITE_VETOES: &[(&[u8], &[u8])] = &[
    ...
    (b"parlinfo.aph.gov.au", b"#documentNavLeft"),
