...
const SITE_WHITELIST: &[(&[u8], &[u8])] = &[
    ...
    (b"encycolorpedia.pt", b"#colorblindness"),
    (b"encycolorpedia.pt", b"#gradients"),
    (b"encycolorpedia.pt", b"#information"),
...
const SITE_VETOES: &[(&[u8], &[u8])] = &[
    ...
    (b"cafemom.com", b".mobile-sig"),
    (b"cheatmasters.com", b".footerlink"),
    (b"cheatmasters.com", b".footertext"),
    (b"cheatmasters.com", b".game_right"),
    (b"cheatmasters.com", b".tabbar"),
    (b"encycolorpedia.pt", b"#alcro"),
    (b"encycolorpedia.pt", b"#amc"),
    (b"encycolorpedia.pt", b"#asian_paints"),
    (b"encycolorpedia.pt", b"#beckers"),
    (b"encycolorpedia.pt", b"#brillux"),
    (b"encycolorpedia.pt", b"#british_standard"),
    (b"encycolorpedia.pt", b"#chrysler"),
    (b"encycolorpedia.pt", b"#cil"),
    (b"encycolorpedia.pt", b"#colortrend"),
    (b"encycolorpedia.pt", b"#coronado_paint"),
    (b"encycolorpedia.pt", b"#craig_rose"),
    (b"encycolorpedia.pt", b"#crayola"),
    (b"encycolorpedia.pt", b"#crown_paint"),
    (b"encycolorpedia.pt", b"#designers_guild"),
    (b"encycolorpedia.pt", b"#diamond_paint"),
    (b"encycolorpedia.pt", b"#diamond_vogel"),
    (b"encycolorpedia.pt", b"#disney"),
    (b"encycolorpedia.pt", b"#dulux_australia"),
    (b"encycolorpedia.pt", b"#dutch_boy"),
    (b"encycolorpedia.pt", b"#earthpaint"),
    (b"encycolorpedia.pt", b"#farrow_ball"),
    (b"encycolorpedia.pt", b"#federal_standard"),
    (b"encycolorpedia.pt", b"#fender"),
    (b"encycolorpedia.pt", b"#fired_earth"),
    (b"encycolorpedia.pt", b"#focoltone"),
    (b"encycolorpedia.pt", b"#ford"),
    (b"encycolorpedia.pt", b"#glidden"),
    (b"encycolorpedia.pt", b"#gm_general_motors"),
    (b"encycolorpedia.pt", b"#graham_brown"),
    (b"encycolorpedia.pt", b"#habitat"),
    (b"encycolorpedia.pt", b"#homebase"),
    (b"encycolorpedia.pt", b"#humbrol"),
    (b"encycolorpedia.pt", b"#jedynka"),
    (b"encycolorpedia.pt", b"#johnstone_s_paint"),
    (b"encycolorpedia.pt", b"#jotun"),
    (b"encycolorpedia.pt", b"#kansai_paint"),
    (b"encycolorpedia.pt", b"#krylon"),
    (b"encycolorpedia.pt", b"#laura_ashley"),
    (b"encycolorpedia.pt", b"#little_greene"),
    (b"encycolorpedia.pt", b"#marston_langinger"),
    (b"encycolorpedia.pt", b"#martha_stewart_living"),
    (b"encycolorpedia.pt", b"#mccormick_paints"),
    (b"encycolorpedia.pt", b"#model_master"),
    (b"encycolorpedia.pt", b"#mylands_of_london"),
    (b"encycolorpedia.pt", b"#nature_paint"),
    (b"encycolorpedia.pt", b"#olympic"),
    (b"encycolorpedia.pt", b"#opaltone_oms"),
    (b"encycolorpedia.pt", b"#opulence"),
    (b"encycolorpedia.pt", b"#pantone_pms"),
    (b"encycolorpedia.pt", b"#porter_paints"),
    (b"encycolorpedia.pt", b"#ppg_pittsburgh_paints"),
    (b"encycolorpedia.pt", b"#ralph_lauren"),
    (b"encycolorpedia.pt", b"#resene"),
    (b"encycolorpedia.pt", b"#revell"),
    (b"encycolorpedia.pt", b"#sanderson"),
    (b"encycolorpedia.pt", b"#sherwin_williams"),
    (b"encycolorpedia.pt", b"#sikkens"),
    (b"encycolorpedia.pt", b"#sto"),
    (b"encycolorpedia.pt", b"#tamiya"),
    (b"encycolorpedia.pt", b"#teknos"),
    (b"encycolorpedia.pt", b"#testors"),
    (b"encycolorpedia.pt", b"#tikkurila"),
    (b"encycolorpedia.pt", b"#tollens"),
    (b"encycolorpedia.pt", b"#toyo_ink"),
    (b"encycolorpedia.pt", b"#trumatch"),
    (b"encycolorpedia.pt", b"#vallejo"),
    (b"encycolorpedia.pt", b"#volkswagen"),
    (b"encycolorpedia.pt", b"#zoffany"),
    (b"foodily.com", b"._buttonAddNewRecipePopup"),
    (b"foodily.com", b"._menu-item"),
    (b"foodily.com", b".top"),
    (b"happysadlola.blogspot.com", b"#sidebar-right-1"),
    (b"happysadlola.blogspot.com", b".column-right-outer"),
    (b"happysadlola.blogspot.com", b".post-share-buttons"),
    (b"newstral.com", b".explanation"),
    (b"query.nytimes.com", b".byline"),
    (b"thorax.bmj.com", b".crumb-navigation"),
];
