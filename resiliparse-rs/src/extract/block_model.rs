// AUTO-GENERATED placeholder (v3 fields) until export runs.
#[derive(Clone, Copy)]
pub struct BlockFeatures {
    ...
    pub comments: f64, pub headings: f64, pub page_headings: f64,
    pub prev_ld: f64, pub next_ld: f64, pub prev_len: f64, pub next_len: f64,
    pub wb: [f64; 32],
}
